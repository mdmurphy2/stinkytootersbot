...
public class HiscoreData {
    ...
    public Hiscore toHiscore() {
        ...
        hiscore.addRank(HiscoreEntry.GOTR, gotrRank);
        hiscore.addLevelOrScore(HiscoreEntry.GOTR, gotrKc);
        hiscore.addRank(HiscoreEntry.ABYSSAL_SIRE, sireRank);
        hiscore.addLevelOrScore(HiscoreEntry.ABYSSAL_SIRE, sireKc);
        hiscore.addRank(HiscoreEntry.ALCHEMICAL_HYDRA, hydraRank);
        hiscore.addLevelOrScore(HiscoreEntry.ALCHEMICAL_HYDRA, hyrdraKc);
        hiscore.addRank(HiscoreEntry.ARTIO, artioRank);
        hiscore.addLevelOrScore(HiscoreEntry.ARTIO, artioKc);
        hiscore.addRank(HiscoreEntry.BARROWS_CHESTS, barrowsRank);
        hiscore.addLevelOrScore(HiscoreEntry.BARROWS_CHESTS, barrowsKc);
        ...
        hiscore.addRank(HiscoreEntry.CALVARION, calvarionRank);
        hiscore.addLevelOrScore(HiscoreEntry.CALVARION, calvarionKc);
        hiscore.addRank(HiscoreEntry.CERBERUS, cerberusRank);
        hiscore.addLevelOrScore(HiscoreEntry.CERBERUS, cerberusKc);
        hiscore.addRank(HiscoreEntry.CHAMBERS_OF_XERIC, coxRank);
        hiscore.addLevelOrScore(HiscoreEntry.CHAMBERS_OF_XERIC, coxKc);
        hiscore.addRank(HiscoreEntry.CHAMBERS_OF_XERIC_CHALLENGE_MODE, coxcmRank);
        hiscore.addLevelOrScore(HiscoreEntry.CHAMBERS_OF_XERIC_CHALLENGE_MODE, coxcmKc);
        ...
        hiscore.addRank(HiscoreEntry.COMMANDER_ZILYANA, zilyanaRank);
        hiscore.addLevelOrScore(HiscoreEntry.COMMANDER_ZILYANA, zilyanaKc);
        hiscore.addRank(HiscoreEntry.CORPOREAL_BEAST, corpRank);
        hiscore.addLevelOrScore(HiscoreEntry.CORPOREAL_BEAST, corpKc);
        hiscore.addRank(HiscoreEntry.CRAZY_ARCHAEOLOGIST, caRank);
        hiscore.addLevelOrScore(HiscoreEntry.CRAZY_ARCHAEOLOGIST, caKc);
        hiscore.addRank(HiscoreEntry.DAGANNOTH_PRIME, primeRank);
        hiscore.addLevelOrScore(HiscoreEntry.DAGANNOTH_PRIME, primeKc);
        hiscore.addRank(HiscoreEntry.DAGANNOTH_REX, rexRank);
        hiscore.addLevelOrScore(HiscoreEntry.DAGANNOTH_REX, rexKc);
        hiscore.addRank(HiscoreEntry.DAGANNOTH_SUPREME, supremeRank);
        hiscore.addLevelOrScore(HiscoreEntry.DAGANNOTH_SUPREME, supremeKc);
        hiscore.addRank(HiscoreEntry.DERANGED_ARCHAEOLOGIST, derangedRank);
        hiscore.addLevelOrScore(HiscoreEntry.DERANGED_ARCHAEOLOGIST, derangedKc);
        hiscore.addRank(HiscoreEntry.DUKE_SUCELLUS, dukeRank);
        hiscore.addLevelOrScore(HiscoreEntry.DUKE_SUCELLUS, dukeKc);
        hiscore.addRank(HiscoreEntry.GENERAL_GRAARDOR, graadrorRank);
        hiscore.addLevelOrScore(HiscoreEntry.GENERAL_GRAARDOR, graardorKc);
        hiscore.addRank(HiscoreEntry.GIANT_MOLE, moleRank);
        hiscore.addLevelOrScore(HiscoreEntry.GIANT_MOLE, moleKc);
        hiscore.addRank(HiscoreEntry.GROTESQUE_GUARDIANS, ggRank);
        hiscore.addLevelOrScore(HiscoreEntry.GROTESQUE_GUARDIANS, ggKc);
        ...
        hiscore.addRank(HiscoreEntry.KING_BLACK_DRAGON, kbdRank);
        hiscore.addLevelOrScore(HiscoreEntry.KING_BLACK_DRAGON, kbdKc);
        hiscore.addRank(HiscoreEntry.KRAKEN, krakenRank);
        hiscore.addLevelOrScore(HiscoreEntry.KRAKEN, krakenKc);
        hiscore.addRank(HiscoreEntry.KREEARRA, kreearraRank);
        hiscore.addLevelOrScore(HiscoreEntry.KREEARRA, kreearraKc);
        ...
        hiscore.addRank(HiscoreEntry.THE_GAUNTLET, gauntletRank);
        hiscore.addLevelOrScore(HiscoreEntry.THE_GAUNTLET, gauntletKc);
        hiscore.addRank(HiscoreEntry.THE_CORRUPTED_GAUNTLET, cgRank);
        hiscore.addLevelOrScore(HiscoreEntry.THE_CORRUPTED_GAUNTLET, cgKc);
        hiscore.addRank(HiscoreEntry.THE_LEVIATHAN, leviathanRank);
        hiscore.addLevelOrScore(HiscoreEntry.THE_LEVIATHAN, leviathanKc);
        hiscore.addRank(HiscoreEntry.THE_WHISPERER, whispererRank);
        hiscore.addLevelOrScore(HiscoreEntry.THE_WHISPERER, whispererKc);
        hiscore.addRank(HiscoreEntry.THEATRE_OF_BLOOD, tobRank);
        hiscore.addLevelOrScore(HiscoreEntry.THEATRE_OF_BLOOD, tobKc);
        hiscore.addRank(HiscoreEntry.THEATRE_OF_BLOOD_HARD_MODE, tobhmRank);
        hiscore.addLevelOrScore(HiscoreEntry.THEATRE_OF_BLOOD_HARD_MODE, tobhmKc);
        hiscore.addRank(HiscoreEntry.THERMONUCLEAR_SMOKE_DEVIL, thermyRank);
        hiscore.addLevelOrScore(HiscoreEntry.THERMONUCLEAR_SMOKE_DEVIL, thermyKc);
        hiscore.addRank(HiscoreEntry.TOMBS_OF_AMASCUT, toaRank);
        hiscore.addLevelOrScore(HiscoreEntry.TOMBS_OF_AMASCUT, toaKc);
        hiscore.addRank(HiscoreEntry.TOMBS_OF_AMASCUT_EXPERT, toaexpertRank);
        hiscore.addLevelOrScore(HiscoreEntry.TOMBS_OF_AMASCUT_EXPERT, toaexpertKc);
        hiscore.addRank(HiscoreEntry.TZKAL_ZUK, zukRank);
        hiscore.addLevelOrScore(HiscoreEntry.TZKAL_ZUK, zukKc);
        hiscore.addRank(HiscoreEntry.TZTOK_JAD, jadRank);
        hiscore.addLevelOrScore(HiscoreEntry.TZTOK_JAD, jadKc);
        hiscore.addRank(HiscoreEntry.VARDORVIS, vardorvisRank);
        hiscore.addLevelOrScore(HiscoreEntry.VARDORVIS, vardorvisKc);
        hiscore.addRank(HiscoreEntry.VENENATIS, venenatisRank);
        hiscore.addLevelOrScore(HiscoreEntry.VENENATIS, venenatisKc);
        hiscore.addRank(HiscoreEntry.VETION, vetionRank);
        hiscore.addLevelOrScore(HiscoreEntry.VETION, vetionKc);
    ...
    public static HiscoreData from(Hiscore hiscore) {
        ...
        data.setGotrRank(hiscore.getRank(HiscoreEntry.GOTR));
        data.setGotrKc(hiscore.getLevelOrScore(HiscoreEntry.GOTR));
        ...
        data.setHydraRank(hiscore.getRank(HiscoreEntry.ALCHEMICAL_HYDRA));
        data.setHyrdraKc(hiscore.getLevelOrScore(HiscoreEntry.ALCHEMICAL_HYDRA));
        data.setArtioRank(hiscore.getRank(HiscoreEntry.ARTIO));
        data.setArtioKc(hiscore.getLevelOrScore(HiscoreEntry.ARTIO));
        data.setBarrowsRank(hiscore.getRank(HiscoreEntry.BARROWS_CHESTS));
        data.setBarrowsKc(hiscore.getLevelOrScore(HiscoreEntry.BARROWS_CHESTS));
        ...
        data.setCalvarionRank(hiscore.getRank(HiscoreEntry.CALVARION));
        data.setCalvarionKc(hiscore.getLevelOrScore(HiscoreEntry.CALVARION));
        ...
        data.setCoxRank(hiscore.getRank(HiscoreEntry.CHAMBERS_OF_XERIC));
        data.setCoxKc(hiscore.getLevelOrScore(HiscoreEntry.CHAMBERS_OF_XERIC));
        data.setCoxcmRank(hiscore.getRank(HiscoreEntry.CHAMBERS_OF_XERIC_CHALLENGE_MODE));
        data.setCoxcmKc(hiscore.getLevelOrScore(HiscoreEntry.CHAMBERS_OF_XERIC_CHALLENGE_MODE));
        ...
        data.setZilyanaRank(hiscore.getRank(HiscoreEntry.COMMANDER_ZILYANA));
        data.setZilyanaKc(hiscore.getLevelOrScore(HiscoreEntry.COMMANDER_ZILYANA));
        data.setCorpRank(hiscore.getRank(HiscoreEntry.CORPOREAL_BEAST));
        data.setCorpKc(hiscore.getLevelOrScore(HiscoreEntry.CORPOREAL_BEAST));
        data.setCaRank(hiscore.getRank(HiscoreEntry.CRAZY_ARCHAEOLOGIST));
        data.setCaKc(hiscore.getLevelOrScore(HiscoreEntry.CRAZY_ARCHAEOLOGIST));
        data.setPrimeRank(hiscore.getRank(HiscoreEntry.DAGANNOTH_PRIME));
        data.setPrimeKc(hiscore.getLevelOrScore(HiscoreEntry.DAGANNOTH_PRIME));
        data.setRexRank(hiscore.getRank(HiscoreEntry.DAGANNOTH_REX));
        data.setRexKc(hiscore.getLevelOrScore(HiscoreEntry.DAGANNOTH_REX));
        data.setSupremeRank(hiscore.getRank(HiscoreEntry.DAGANNOTH_SUPREME));
        data.setSupremeKc(hiscore.getLevelOrScore(HiscoreEntry.DAGANNOTH_SUPREME));
        data.setDerangedRank(hiscore.getRank(HiscoreEntry.DERANGED_ARCHAEOLOGIST));
        data.setDerangedKc(hiscore.getLevelOrScore(HiscoreEntry.DERANGED_ARCHAEOLOGIST));
        data.setDukeRank(hiscore.getRank(HiscoreEntry.DUKE_SUCELLUS));
        data.setDukeKc(hiscore.getLevelOrScore(HiscoreEntry.DUKE_SUCELLUS));
        data.setGraadrorRank(hiscore.getRank(HiscoreEntry.GENERAL_GRAARDOR));
        data.setGraardorKc(hiscore.getLevelOrScore(HiscoreEntry.GENERAL_GRAARDOR));
        data.setMoleRank(hiscore.getRank(HiscoreEntry.GIANT_MOLE));
        data.setMoleKc(hiscore.getLevelOrScore(HiscoreEntry.GIANT_MOLE));
        data.setGgRank(hiscore.getRank(HiscoreEntry.GROTESQUE_GUARDIANS));
        data.setGgKc(hiscore.getLevelOrScore(HiscoreEntry.GROTESQUE_GUARDIANS));
        ...
        data.setKbdRank(hiscore.getRank(HiscoreEntry.KING_BLACK_DRAGON));
        data.setKbdKc(hiscore.getLevelOrScore(HiscoreEntry.KING_BLACK_DRAGON));
        data.setKrakenRank(hiscore.getRank(HiscoreEntry.KRAKEN));
        data.setKrakenKc(hiscore.getLevelOrScore(HiscoreEntry.KRAKEN));
        data.setKreearraRank(hiscore.getRank(HiscoreEntry.KREEARRA));
        data.setKreearraKc(hiscore.getLevelOrScore(HiscoreEntry.KREEARRA));
        ...
        data.setGauntletRank(hiscore.getRank(HiscoreEntry.THE_GAUNTLET));
        data.setGauntletKc(hiscore.getLevelOrScore(HiscoreEntry.THE_GAUNTLET));
        data.setCgRank(hiscore.getRank(HiscoreEntry.THE_CORRUPTED_GAUNTLET));
        data.setCgKc(hiscore.getLevelOrScore(HiscoreEntry.THE_CORRUPTED_GAUNTLET));
        data.setLeviathanRank(hiscore.getRank(HiscoreEntry.THE_LEVIATHAN));
        data.setLeviathanKc(hiscore.getLevelOrScore(HiscoreEntry.THE_LEVIATHAN));
        data.setWhispererRank(hiscore.getRank(HiscoreEntry.THE_WHISPERER));
        data.setWhispererKc(hiscore.getLevelOrScore(HiscoreEntry.THE_WHISPERER));
        data.setTobRank(hiscore.getRank(HiscoreEntry.THEATRE_OF_BLOOD));
        data.setTobKc(hiscore.getLevelOrScore(HiscoreEntry.THEATRE_OF_BLOOD));
        data.setTobhmRank(hiscore.getRank(HiscoreEntry.THEATRE_OF_BLOOD_HARD_MODE));
        data.setTobhmKc(hiscore.getLevelOrScore(HiscoreEntry.THEATRE_OF_BLOOD_HARD_MODE));
        data.setThermyRank(hiscore.getRank(HiscoreEntry.THERMONUCLEAR_SMOKE_DEVIL));
        data.setThermyKc(hiscore.getLevelOrScore(HiscoreEntry.THERMONUCLEAR_SMOKE_DEVIL));
        data.setToaRank(hiscore.getRank(HiscoreEntry.TOMBS_OF_AMASCUT));
        data.setToaKc(hiscore.getLevelOrScore(HiscoreEntry.TOMBS_OF_AMASCUT));
        data.setToaexpertRank(hiscore.getRank(HiscoreEntry.TOMBS_OF_AMASCUT_EXPERT));
        data.setToaexpertKc(hiscore.getLevelOrScore(HiscoreEntry.TOMBS_OF_AMASCUT_EXPERT));
        data.setZukRank(hiscore.getRank(HiscoreEntry.TZKAL_ZUK));
        data.setZukKc(hiscore.getLevelOrScore(HiscoreEntry.TZKAL_ZUK));
        data.setJadRank(hiscore.getRank(HiscoreEntry.TZTOK_JAD));
        data.setJadKc(hiscore.getLevelOrScore(HiscoreEntry.TZTOK_JAD));
        ...
        data.setVenenatisRank(hiscore.getRank(HiscoreEntry.VENENATIS));
        data.setVenenatisKc(hiscore.getLevelOrScore(HiscoreEntry.VENENATIS));
        data.setVetionRank(hiscore.getRank(HiscoreEntry.VETION));
        data.setVetionKc(hiscore.getLevelOrScore(HiscoreEntry.VETION));
